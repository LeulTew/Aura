    ...
    return (
        <main className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden font-sans">
            ...
            <div className="text-center z-10">
                <h1 className="text-5xl md:text-6xl font-extralight tracking-tight mb-16 animate-reveal text-white">
                    Your Photos,{" "}
                ...
                {error && (
                    <p className="mt-8 text-red-500 text-sm font-mono tracking-tighter uppercase">{error}</p>
                )}
            </div>
